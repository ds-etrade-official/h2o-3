...
public class GAMISplineTest extends TestUtil {
    ...
    public void testCSISTransform() {
        ...
        try {
            ...
            Frame isc_2  = extractGamifiedColumns(train, new String[][]{{"c_2"}}, new int[]{2}, new double[]{0.001},
            ...
            Frame isc_5  = extractGamifiedColumns(train, new String[][]{{"c_5"}}, new int[]{2}, new double[]{0.001},
                    new int[]{2}, new int[]{10}, ignoredCols(colNames, Arrays.asList("c_5")), gaussian);
            assertCorrectGamification(allGamifiedColumns, isc_5);
            Frame isc_6  = extractGamifiedColumns(train, new String[][]{{"c_6"}}, new int[]{2}, new double[]{0.001},
                    new int[]{2}, new int[]{9}, ignoredCols(colNames, Arrays.asList("c_6")), gaussian);
            assertCorrectGamification(allGamifiedColumns, isc_6);
            Frame isc_7  = extractGamifiedColumns(train, new String[][]{{"c_7"}}, new int[]{2}, new double[]{0.001},
    ...
    public void testISCSTPTransform() {
        ...
        try {
            ...
            Frame isc_9  = extractGamifiedColumns(train, new String[][]{{"c_9"}}, new int[]{2}, new double[]{0.001},
